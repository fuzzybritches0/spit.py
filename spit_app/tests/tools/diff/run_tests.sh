...
out=$($H --file1 fixtures/shared-a.txt --file2 fixtures/shared-b.txt --context 3 --output_format unified)
check "t1-rc" 0 $?
...
echo
echo "=== 2. Context diff ==="
out=$($H --file1 fixtures/shared-a.txt --file2 fixtures/shared-b.txt --context 1 --output_format context)
check "t2-rc" 0 $?
...
echo
echo "=== 3. Side-by-side ==="
out=$($H --file1 fixtures/shared-a.txt --file2 fixtures/shared-b.txt --context 3 --output_format side_by_side)
check "t3-rc" 0 $?
...
out=$($H --file1 fixtures/shared-a.txt --file2 fixtures/t04-identical.txt --context 3 --output_format unified)
check "t4-rc" 0 $?
expect_output "t4-msg" "$out" "are identical"

echo
echo "=== 5. Missing file -> error ==="
out=$($H --file1 fixtures/shared-a.txt --file2 fixtures/t05-no-such-file.txt --context 3 --output_format unified)
check "t5-rc" 1 $?
expect_output "t5-msg" "$out" "ERROR"

echo
echo "=== 6. Bad output_format -> error ==="
out=$($H --file1 fixtures/shared-a.txt --file2 fixtures/shared-b.txt --context 3 --output_format bogus)
check "t6-rc" 1 $?
expect_output "t6-msg" "$out" "invalid output_format"

echo
echo "=== 7. Directory as file -> error ==="
out=$($H --file1 fixtures/shared-a.txt --file2 fixtures --context 3 --output_format unified)
check "t7-rc" 1 $?
