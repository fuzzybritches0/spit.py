...
out=$($H --path fixtures/t01-src --pattern grep_me --file_pattern "*" --recursive True --context 0 --max_results 100)
check "t1-rc" 0 $?
...
out=$($H --path fixtures/t01-src --pattern grep_me --file_pattern "*.py" --recursive True --context 0 --max_results 100)
check "t2-rc" 0 $?
...
out=$($H --path fixtures/t01-src --pattern grep_me --file_pattern "*" --recursive False --context 0 --max_results 100)
check "t3-rc" 0 $?
...
out=$($H --path fixtures/t01-src --pattern "grep_me" --file_pattern "notes.txt" --recursive True --context 1 --max_results 100)
check "t4-rc" 0 $?
...
out=$($H --path fixtures/t01-src --pattern grep_me --file_pattern "*" --recursive True --context 0 --max_results 2)
check "t5-rc" 0 $?
...
echo
echo "=== 6. No matches ==="
out=$($H --path fixtures/t01-src --pattern "zzz_no_such_pattern" --file_pattern "*" --recursive True --context 0 --max_results 100)
check "t6-rc" 0 $?
expect_output "t6-msg" "$out" "No matches found for"

echo
echo "=== 7. Single file as path ==="
cp fixtures/t01-src/app.py fixtures/t07-single-file.txt
out=$($H --path fixtures/t07-single-file.txt --pattern "grep_me" --file_pattern "*" --recursive True --context 0 --max_results 100)
check "t7-rc" 0 $?
expect_output "t7-count" "$out" "Found 3 match(es)"

echo
echo "=== 8. Binary file skip ==="
out=$($H --path fixtures/t01-src --pattern "binary" --file_pattern "blob.bin" --recursive True --context 0 --max_results 100)
...
out=$($H --path fixtures/t09-no-such-dir --pattern x --file_pattern "*" --recursive True --context 0 --max_results 100)
check "t9-rc" 1 $?
expect_output "t9-msg" "$out" "ERROR"

echo
echo "=== 10. Invalid regex -> error ==="
out=$($H --path fixtures/t01-src --pattern "[invalid" --file_pattern "*" --recursive True --context 0 --max_results 100)
check "t10-rc" 1 $?
expect_output "t10-msg" "$out" "Invalid regular expression"

echo
echo "=== 11. Regex pattern with special chars ==="
out=$($H --path fixtures/t01-src --pattern 'def grep_me' --file_pattern "*.py" --recursive True --context 0 --max_results 100)
check "t11-rc" 0 $?
